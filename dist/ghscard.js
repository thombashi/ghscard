...
exports.DEFAULT_SEMANTIC_UI_CSS_URL = (CDN_PREFIX + "/semantic-ui/" + SEMANTIC_UI_VERSION + "/semantic.min.css");
var Emoji;
(function (Emoji) {
    Emoji.WIDTH = 16;
    Emoji.HEIGHT = 16;
...
var AbstractRepositoryCardGerator = (function (_super) {
    ...
    AbstractRepositoryCardGerator.prototype.createCardContent = function () {
        ...
        var childArray = [
            ...
            this.createElementWithChild(segmentClassName, [this.createDescription(this.getDescription())]),
        ];
        {
            var infoArray = [];
    ...
    switch (cardType) {
        case "repository": {
            switch (cardStyle) {
                ...
                case "tiny": {
                    return new tiny_1.TinyRepoCardGerator(iframeDocument, cardData, color, chartVisibility, emojiProcessor);
                }
                default: {
        ...
        case "user": {
            switch (cardStyle) {
                ...
                case "tiny": {
                    return new tiny_2.TinyUserCardGerator(iframeDocument, cardData, color, emojiProcessor);
                }
                default: {
                    console.error("invalid card style: type=" + cardType + ", style=" + cardStyle);
                }
        ...
        Array.prototype.forEach.call(this._doc.getElementsByClassName("ghscard"), function (cardElement) {
            ...
            $.getJSON(dataSourcePath, function (cardData) {
                ...
                iframeBufferDocument.body.appendChild(cardGenerator.createCard());
                {
                    ...
                    scriptElement.appendChild(_this._doc.createTextNode(scriptContent));
...
Object.defineProperty(exports, "__esModule", { value: true });
var base_user_1 = __webpack_require__(3);
